...
doTweenX('hi2', 'hi2.scale', 0 - 100*math.sin((currentBeat+1*0.1)*math.pi), 6)
doTweenY('hi2y', 'hi2.scale', 0 - 100*math.sin((currentBeat+1*1)*math.pi), 6)
	if curStep < 895 then
